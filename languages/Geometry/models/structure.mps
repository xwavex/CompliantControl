...
<model ref="r:19496bad-2dd3-478c-9baf-0de95edabf63(Geometry.structure)">
  ...
  <node concept="PlHQZ" id="4lvPSgOQR2F">
    <property role="EcuMT" value="4998951074226991275" />
    <property role="TrG5h" value="ITrajectory" />
    <property role="3GE5qa" value="trajectory" />
    <node concept="PrWs8" id="4lvPSgOQR3g" role="PrDN$">
      <ref role="PrY4T" to="tpck:h0TrEE$" resolve="INamedConcept" />
    </node>
  </node>
  <node concept="1TIwiD" id="4lvPSgOQR26">
    <property role="EcuMT" value="4998951074226991238" />
    <property role="TrG5h" value="TrajectoryRef" />
    <property role="3GE5qa" value="trajectory" />
    <ref role="1TJDcQ" to="tpck:gw2VY9q" resolve="BaseConcept" />
    <node concept="1TJgyj" id="4lvPSgOQR4r" role="1TKVEi">
      <property role="IQ2ns" value="4998951074226991387" />
      <property role="20lmBu" value="reference" />
      <property role="20kJfa" value="traj" />
      <property role="20lbJX" value="1" />
      <ref role="20lvS9" node="4lvPSgOQR2F" resolve="ITrajectory" />
    </node>
  </node>
  <node concept="1TIwiD" id="4lvPSgOQRve">
    <property role="EcuMT" value="4998951074226993102" />
